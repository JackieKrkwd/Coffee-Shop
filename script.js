...
let menuItems = [
  {
    ...
    name: "Coffee",
    category: "Drink",
    description: "Your classic go-to. Simple, bold, coffee.",
    price: 2,
  },
  {
  ...
  },
  {
    ...
    name: "Espresso",
    category: "Drink",
    description: "A 'shot' of really strong coffee to pick you up.",
    price: 3.5,
  },
  {
    ...
    category: "Drink",
    description:
      "One part espresso filled with steamed milk. A delicious pick-me up.",
    price: 4,
  },
  {
    ...
    category: "Drink",
    description:
      "Our original roast, just on ice. Add cream or milk to make it your own.",
    price: 2.5,
  },
  {
    ...
    category: "Drink",
    description:
      "Nitrogen infused cold brew for naturally sweet flavor and texture.",
    price: 4,
  },
  {
    ...
    name: "Cookie",
    category: "Food",
    description: "Sugar cookie with frosting and sprinkles.",
    price: 1,
  },
  {
    ...
    name: "Muffin",
    category: "Food",
    description: "Choose from blueberry, strawberry, or chocolate chip.",
    price: 2,
  },
  {
    ...
    name: "Croissant",
    category: "Food",
    description: "Buttery, flaky pastry. So good you'll want another.",
    price: 2.5,
  },
  {
    ...
    name: "Doughnut",
    category: "Food",
    description: "Cake doughnut dipped in chocolate and topped with sprinkles.",
    price: 2,
  },
];
